                ...
                <div className="w-full md:w-[55%] flex flex-col h-full bg-[#0a1a14] min-h-0">
                    ...
                    <footer className="p-8 md:p-12 pt-6 border-t border-white/5 bg-[#0a1a14] flex-shrink-0 shadow-[0_-10px_30px_rgba(0,0,0,0.5)]">
                        ...
                        <div className="flex justify-between items-baseline mb-6 px-1">
                            <span className="text-[10px] uppercase tracking-[0.2em] text-white/30 font-bold">Prix de l'atelier</span>
                            <span className="text-3xl md:text-4xl font-serif text-rhum-gold">{detail.price}</span>
                        </div>
