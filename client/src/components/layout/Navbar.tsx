            ...
            <nav className={`fixed w-full top-0 left-0 z-50 transition-all duration-500 border-b ${
                ...
                <div className="max-w-7xl mx-auto px-8 md:px-16 flex justify-between items-center">
                    ...
                    <div className="flex-shrink-0">
                        <button
                            onClick={toggleLang}
                            className="text-rhum-cream text-[10px] font-black tracking-widest hover:text-rhum-gold uppercase"
                        >
                    ...
                    <div className="flex items-center gap-6 md:gap-10">
                        ...
                        {/* 3. PANIER AVEC BADGE ANIMÉ */}
                        <button
                            onClick={onOpenCart}
                            className="relative p-2 text-rhum-gold hover:text-white transition-colors"
                        >
                            ...
                            <AnimatePresence>
                                {cartCount > 0 && (
                                    <motion.span
                                        ...
                                        animate={{ scale: 1 }}
                                        exit={{ scale: 0 }}
                                        className="absolute -top-0 -right-0 bg-rhum-gold text-rhum-green text-[8px] font-black w-4 h-4 rounded-full flex items-center justify-center"
                                    >
                                        {cartCount}
                                    </motion.span>
                                )}
                        ...
                        {user ? (
                            ...
                            <button
                                ...
                                className={`hidden lg:block px-8 py-2.5 text-[9px] font-black uppercase tracking-[0.2em] transition-all rounded-full ${
                                    isScrolled
                            ...
                            <div className="flex flex-col p-10 gap-8 text-center items-center">
                                ...
                                {user ? (
                                    ...
                                    <button
                                        ...
                                        className="mt-4 w-full max-w-[240px] px-8 py-4 bg-rhum-gold text-rhum-green text-[10px] font-black uppercase tracking-[0.2em] rounded-full"
                                    >
                                        SE CONNECTER
                                    </button>
                                )}
